...
**All Parties**: Use this menu to navigate through customer, vendor, and employee records, and more.

**Customers**: Use this menu to manage payment transaction records.

**Products**: Use this menu to manage all items in the system, including products, services, configurators, and equipment.
